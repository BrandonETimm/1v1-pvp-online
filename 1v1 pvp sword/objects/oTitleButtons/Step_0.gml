if (oSettings.shown || oProfiles.shown) exit;
...
if (key_select){
	switch(btnSelected){
		case 0: 
			instance_create_layer(0,0,"Buttons",oPlayButtons);
			instance_destroy();
			break;
		case 1: oProfiles.shown = true; break;
		case 2: oSettings.shown = true; break;
		case 3: game_end(0); break;
	}
}